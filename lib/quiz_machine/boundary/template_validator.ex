defmodule QuizMachine.Boundary.TemplateValidator do
  ...
  defp validate_instructions(_instructions), do: {:error, "must be a binary string"}
  ...
  defp validate_checker(_checker), do: {:error, "must be an arity of 2 function"}
end
